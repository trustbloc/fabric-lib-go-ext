...
// GetProjectPath returns the path to the source of the project. More specifically, this function searches for the
...
func getProjectPath() string {
	...
	// In that case, set the FABRIC_LIB_GO_EXT_PROJECT_PATH environment
	// variable to the correct project root
	val, ok := os.LookupEnv("FABRIC_LIB_GO_EXT_PROJECT_PATH")
	if ok {
		return val
	}

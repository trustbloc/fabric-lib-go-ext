...
where interfaces and functions are removed to minimize for local cryptosuite usage.
...
//CryptoSuite adaptor for all bccsp functionalities used by cryptosuite

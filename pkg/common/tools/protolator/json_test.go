...
func TestMarshalBlock(t *testing.T) {
	...
	builder := &mocks.MockConfigBlockBuilder{
		MockConfigGroupBuilder: mocks.MockConfigGroupBuilder{
			...
			RootCA:                  cert,
			ChannelCapabilities:     []string{v1_1Capability},
			OrdererCapabilities:     []string{v1_1Capability, v2_0Capability},
			ApplicationCapabilities: []string{v1_2Capability, capability1},
		},
		Index:           0,
		LastConfigIndex: 0,
	}

...
import (
	...
	"github.com/trustbloc/fabric-lib-go-ext/pkg/common/options"
	"github.com/trustbloc/fabric-lib-go-ext/pkg/util/concurrent/futurevalue"
	"github.com/trustbloc/fabric-lib-go-ext/pkg/util/concurrent/lazyref"
)

var logger = logging.NewLogger("fabric-lib/util")

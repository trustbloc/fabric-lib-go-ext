...
func TestEnvSubst(t *testing.T) {
	...
	err = os.Unsetenv("FABGOLIB_TESTVAR")
...
func TestEnvPriority(t *testing.T) {
	...
	assert.Equal(t, e, s, "Unexpected path substitution (lib variable should take priority)")
...
func TestSubstProjectPath(t *testing.T) {
	o := "$foo${FABRIC_LIB_GO_EXT_PROJECT_PATH}foo"
	s := Subst(o)
